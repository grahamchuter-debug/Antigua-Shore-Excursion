#!/usr/bin/env python3
"""Generate /book/{slug}/ and /book/{slug}/received/ for Antigua Classic Beach Day RTB."""
...
from antigua_shell import footer_html, nav_html  # noqa: E402

PRODUCTS = [
    {
        "id": "classic-beach-day",
        "name": "Classic Beach Day",
        "product_path": "/classic-beach-day/",
        "price_list": (
            "<li>Guests (ages 3+) — $77</li>"
            "<li>Infants (0–2) — free (still recorded)</li>"
        ),
        "duration": "4 hours at Fryes Beach",
        "meeting": (
            "Meeting: approximately 5–10 minute walk from the cruise ship pier. "
            "Exact instructions after confirmation."
        ),
        "truth": (
            "Includes lunch, a non-alcoholic welcome drink, and transport as part of the excursion. "
            "Optional Cades Reef boat/snorkel and optional water sports are at your own expense and "
            "are not included. Not wheelchair accessible. Moderate activity."
        ),
    },
]
...
def guest_fieldset(name: str) -> str:
    return f"""
        <fieldset class="booking-fieldset">
          ...
          <label for="adults">Guests (ages 3+) <span class="muted">— $77 each</span>
          ...
          <p class="help">At least one paying guest (ages 3+) is required. Infants are free but must be included. Maximum 10 guests online. For larger groups email <a href="mailto:hello@antiguashoreexcursion.com">hello@antiguashoreexcursion.com</a>.</p>
        </fieldset>
        <div class="booking-review" id="booking-review" aria-live="polite">
          ...
          <dl>
            ...
            <div id="rev-infants-row"><dt>Infants (0–2)</dt><dd id="rev-infants">—</dd></div>
...
<head>
  ...
  <title>Book {name} | Antigua Shore Excursions</title>
  <meta name="description" content="Request {name} online. Pay securely to request — confirmation is emailed separately." />
  <link rel="canonical" href="https://antiguashoreexcursion.com/book/{pid}/" />
...
<section class="section booking-flow">
  <div class="wrap booking-shell px-4 sm:px-6">
    ...
    <div class="booking-panel">
      ...
      <form class="booking-form" id="atg-booking-form" method="post" action="#" data-product-id="{pid}" data-live="0" novalidate>
        <fieldset class="booking-fieldset">
          ...
          <p class="help">Enter your ship and date. We do not invent a published Antigua ship-call schedule — availability is confirmed after your request.</p>
        </fieldset>
{guest_fieldset(name)}
        <fieldset class="booking-fieldset">
        ...
        <p class="help" id="booking-footer-note">Prefer to ask first? <a href="mailto:hello@antiguashoreexcursion.com">hello@antiguashoreexcursion.com</a></p>
      </form>
    </div>
  </div>
</section>
...
<head>
  <meta charset="UTF-8" />
  <meta name="viewport" content="width=device-width, initial-scale=1.0" />
  <title>Booking request received | Antigua Shore Excursions</title>
  <meta name="description" content="Your Antigua excursion payment was received. This is a booking request, not a confirmation." />
  <link rel="canonical" href="https://antiguashoreexcursion.com/book/{pid}/received/" />
  <meta name="robots" content="noindex,follow" />
  <link rel="preconnect" href="https://fonts.googleapis.com" />
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin />
  <link href="https://fonts.googleapis.com/css2?family=Outfit:wght@500;600;700&amp;family=Source+Sans+3:wght@400;500;600;700&amp;display=swap" rel="stylesheet" />
...
<section class="section booking-flow">
  <div class="wrap booking-shell px-4 sm:px-6">
    ...
    <div class="booking-actions">
      ...
      <a class="btn btn--outline" href="mailto:hello@antiguashoreexcursion.com">Contact us</a>
    </div>
  </div>
</section>
